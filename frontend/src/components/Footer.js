    ...
    <footer className="bg-white border-t border-gray-200">
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          {/* Brand Column */}
          <div>
            <h3 className="text-xl font-light tracking-widest mb-6">Kusuri Mane</h3>
          ...
          {/* Empty Column (for spacing like Wix) */}
          <div></div>
          ...
          {/* Newsletter Column */}
          <div>
            <h4 className="text-sm font-medium mb-6">Connect with Us</h4>
            <form onSubmit={handleSubscribe} className="space-y-4">
              ...
              <button
                type="submit"
                className="bg-black text-white px-8 py-2 text-sm font-medium hover:bg-gray-800 transition-colors w-full"
              >
        ...
        <div className="text-xs text-gray-600">
          <p>© 2025 by KusuriMane. Powered and secured by Wix</p>
        </div>
      </div>
    </footer>
  );
